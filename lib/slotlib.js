...
var signCSR = function(params, callback) {
    ...
    let statecerts = statelib.get().certificates;
    if(statecerts.hasOwnProperty(params.serial)) {
        if(statecerts[params.serial].hasOwnProperty(params.objectid)) {
            if(statecerts[params.serial][params.objectid].hasOwnProperty('Certificate Object')) {
                if(statecerts[params.serial][params.objectid]['Certificate Object'][0].hasOwnProperty('private_key')) {
                    hashalg = common.getAllowedHashAlg(statecerts[params.serial][params.objectid]['Certificate Object'][0].private_key);
