...
var sendRequest = function(params, callback) {
    ...
    request({options: options, body: params.smime}, function(err, resp) {
        if(err) {
            callback(err, resp);
        } else {
            console.log(resp);
...
var createRequest = function(jsonrequest, cert, issued, callback) {
    smime.signRequest({ json: jsonrequest, cert: issued, key: cert.channel.key }, function(err, request) {
        if(err) {
            callback(err, false);
        } else {
            ...
            if(err) {
                ...
                createRequest(jsonrequest, certs[index], cert, function(err, request) {
                    if(err) {
                        ...
                        //console.log(request);
                        sendRequest(jsonrequest, function(err, response) {
                            if(err) {
                                callback(err, false);
                            } else {
